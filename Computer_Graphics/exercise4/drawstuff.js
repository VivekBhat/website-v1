...
function getCanvas(viewportID, testEye, viewVector){
 // Get the canvas, context, and image data
 var canvas = document.getElementById(viewportID); 
...
//  var testEye = new Vector(Va,Vb,Vc);
...
var viewVector = new Vector(1,1,0);	
getCanvas("viewport1",testEye,viewVector);

var testEye = new Vector(-10,5,0);
var viewVector = new Vector(0,1,0);

getCanvas("viewport2",testEye,viewVector);
