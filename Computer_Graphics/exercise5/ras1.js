...
function setupShaders() {
    ...
    var fShaderCode = `
        ...
        void main(void) {
            gl_FragColor =vec4(0,0,1,1); // all fragments are white
        }
    `;
    ...
    var vShaderCode = `
        ...
        void main(void) {
            gl_Position = vec4(vertexPosition.x-0.7,vertexPosition.y-0.7,vertexPosition.z,1.0); // use the untransformed position
