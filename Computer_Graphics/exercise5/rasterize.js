...
function setupShaders() {
    ...
    var fShaderCode = `
        void main(void) {
            gl_FragColor = vec4(0.7, 1.0, 1.0, 1.0); // all fragments are white
        }
    `;
    ...
    var vShaderCode = `
        ...
        void main(void) {
            gl_Position = vec4(vertexPosition.x-0.6,vertexPosition.y-0.5,vertexPosition.z, 1.0); // use the untransformed position
        }
    `;
