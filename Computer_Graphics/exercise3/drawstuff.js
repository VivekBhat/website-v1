...
function main() {
    ...
    var fixColor  = new Color(150,100,255);    // I have added this new var to avoid the repetition                  
    // Define a rectangle in 2D with colors and coords at corners
    var globals = { lightPos: new Vector(135,135,45),  // light over left upper rect
                    lightCol: new Color(255,255,255)}; // light is white
    
    var tlAttribs = { diffuse: fixColor};    // all four rect verts blue
    var trAttribs = { diffuse: fixColor};
    var brAttribs = { diffuse: fixColor};
    var blAttribs = { diffuse: fixColor};
    interpRect(imagedata,100,300,100,400,globals,tlAttribs,trAttribs,brAttribs,blAttribs);
